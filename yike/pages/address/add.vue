	...
	<view class="address">
		<view class="goodsPopupAddress">
			...
			<view class="addressLi">
				...
				<uni-data-picker class="addressLiPicker" mode="multiLinkageSelector" :localdata="regionData"
					:value="selectedRegion" @change="onChange" placeholder="请选择地区">
				</uni-data-picker>
			</view>
			<view class="addressLi">
		...
		<view class="addressConBtn">
			...
			<view class="addressConBtnDel" @click="delAddress()">
				删除地址
			</view>
		</view>
	</view>
		...
		methods: {
			...
			getInfo() {
				AddressApi.getInfo({
					...
					// this.selectedRegion = [{"text":"安徽","value":"3-1"},{"text":"蚌埠","value":"37-3"},{"text":"东市区","value":"410-37"}];
				}).catch(res => {
					console.log(res)
				})
			},
