	...
	<view class="handleScroll" @scroll="handleScroll">
			...
			<view class="indexTopPositionCon">
				<view class="indexTopPositionConSearch">
					...
					<view class="indexTopPositionConSearchCity">
						<image src="../../static/images/index_1.png" class="indexTopPositionConSearchCityIcon" mode="widthFix">
						</image>
						<uni-data-picker :clear-icon="false" class="indexTopPositionConSearchCityPick" :localdata="items"
							popup-title="城市"></uni-data-picker>
					</view>
					<!-- 搜索 -->
		...
		<view class="fourmRecommend">
			...
			<view class="forumSelect">
				...
				<uni-data-select class="forumSelectC" v-model="valueSe" :localdata="range" @change="changeSe"></uni-data-select>
			</view>
	...
	export default {
		...
		data() {
			return {
				...
				activePage: 1,
				scrollText: ['哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈', '嘿嘿红红火火恍恍惚惚哈哈哈哈哈哈嘿嘿红红火火恍恍惚惚哈哈哈哈哈哈', '红红火火嘿嘿红红火火恍恍惚惚哈哈哈哈哈哈',
