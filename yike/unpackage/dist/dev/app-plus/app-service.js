...
(function(vue) {
  ...
  const apiUrl = api_url_config.release.hjs_request_url;
  ...
  function getPageUrl(is_whole = true) {
    var url = currentPage();
    if (is_whole == false) {
      var temp = url.split("?");
      url = temp[0];
    ...
    methods: {
      ...
      loginEvent(e2) {
        ...
        uni[action]({
          ...
          success: (res) => {
            ...
            if (res.code) {
              IndexApi.login({
                ...
                formatAppLog("log", "at pages/login/login.vue:112", res2);
                uni.hideLoading();
              });
            } else {
              uni.hideLoading();
          ...
          fail: (e3) => {
            formatAppLog("log", "at pages/login/login.vue:120", "授权失败, ", e3);
            uni.hideLoading();
            showToast("授权失败");
          }
        });
    ...
    return vue.openBlock(), vue.createElementBlock(
      ...
      [
        ...
        vue.createElementVNode("view", { class: "loginBack" }, [
          ...
          vue.createElementVNode("view", { class: "loginTopTit" }, " 买配件 · 发友圈 · 求职招聘 · 在线聊天 "),
          ...
          vue.createElementVNode("navigator", { class: "loginWechat" }, [
            ...
            vue.createElementVNode("text", {
              onClick: _cache[0] || (_cache[0] = (...args) => $options.loginEvent && $options.loginEvent(...args))
            }, "微信登录")
          ]),
  ...
  const PagesLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["render", _sfc_render$O], ["__file", "D:/cindy/yikegongcheng/yike/pages/login/login.vue"]]);
  const _sfc_main$O = {
    data() {
      return {
        items: [
    ...
    methods: {
      ...
      getGoodsClassTopOffsetTop() {
        const query = uni.createSelectorQuery().in(this);
        query.select(".goodsClassTop").boundingClientRect((data) => {
          this.goodsClassTopOffsetTop = data.top;
        }).exec();
      },
      onPageScroll(e2) {
        if (e2.scrollTop >= this.goodsClassTopOffsetTop) {
      ...
      goToLeasing() {
        uni.navigateTo({
          url: "../device/device-con"
        });
      }
    },
    onReady() {
      const query = uni.createSelectorQuery();
      query.select(".goodsClassTop").boundingClientRect((rect) => {
        this.topThreshold = rect.top;
      }).exec();
    },
    onPageScroll(e2) {
      if (e2.scrollTop >= this.topThreshold) {
        this.isSticky = true;
      } else {
        this.isSticky = false;
      }
    ...
    return vue.openBlock(), vue.createElementBlock(
      ...
      [
        ...
        vue.createElementVNode("view", { class: "" }, [
          ...
          vue.createElementVNode("view", { class: "devicebtn" }, [
            vue.createElementVNode("navigator", {
              url: "../../pages/device/device-lease",
              class: "devicebtn_2"
            }, "设备租赁"),
            vue.createElementVNode("navigator", {
              url: "../../pages/device/device-shop",
              class: "devicebtn_1"
            }, "设备商城")
          ]),
          vue.createElementVNode(
            "view",
            {
              class: vue.normalizeClass({ "goodsClassTop": true, "sticky": $data.isSticky })
            },
            [
          ...
          vue.createElementVNode("view", { class: "leasingUl" }, [
            vue.createElementVNode("view", {
              class: "leasingUlLi",
              onClick: _cache[0] || (_cache[0] = (...args) => $options.goToLeasing && $options.goToLeasing(...args))
            }, [
              vue.createElementVNode("image", {
                class: "leasingUlLiImg",
            ...
            vue.createElementVNode("view", {
              class: "leasingUlLi",
              onClick: _cache[1] || (_cache[1] = (...args) => $options.goToLeasing && $options.goToLeasing(...args))
            }, [
              vue.createElementVNode("image", {
                class: "leasingUlLiImg",
                src: "/static/images/goods_1.png"
            ...
            vue.createElementVNode("view", {
              class: "leasingUlLi",
              onClick: _cache[2] || (_cache[2] = (...args) => $options.goToLeasing && $options.goToLeasing(...args))
            }, [
              vue.createElementVNode("image", {
                class: "leasingUlLiImg",
                src: "/static/images/goods_1.png"
            ...
            vue.createElementVNode("view", {
              class: "leasingUlLi",
              onClick: _cache[3] || (_cache[3] = (...args) => $options.goToLeasing && $options.goToLeasing(...args))
            }, [
              vue.createElementVNode("image", {
                class: "leasingUlLiImg",
                src: "/static/images/goods_1.png"
            ...
            vue.createElementVNode("view", {
              class: "leasingUlLi",
              onClick: _cache[4] || (_cache[4] = (...args) => $options.goToLeasing && $options.goToLeasing(...args))
            }, [
              vue.createElementVNode("image", {
                class: "leasingUlLiImg",
                src: "/static/images/goods_1.png"
            ...
            vue.createElementVNode("view", {
              class: "leasingUlLi",
              onClick: _cache[5] || (_cache[5] = (...args) => $options.goToLeasing && $options.goToLeasing(...args))
            }, [
              vue.createElementVNode("image", {
                class: "leasingUlLiImg",
                src: "/static/images/goods_1.png"
  ...
  const PagesDeviceDeviceLease = /* @__PURE__ */ _export_sfc(_sfc_main$O, [["render", _sfc_render$N], ["__file", "D:/cindy/yikegongcheng/yike/pages/device/device-lease.vue"]]);
  const _sfc_main$N = {
    methods: {
      makePhoneCall() {
        uni.makePhoneCall({
  ...
  function _sfc_render$M(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock(
      ...
      [
        ...
        vue.createElementVNode("view", { class: "leasingCon" }, [
          vue.createElementVNode("image", {
            class: "leasingConImg",
            src: "/static/images/goods_1.png",
            mode: "widthFix"
          }),
          vue.createElementVNode("view", { class: "leasingConTop" }, [
            vue.createElementVNode("text", { class: "leasingConTop_t1" }, "吉林 长春 工程车租赁一天/1000元工程车租赁一天/1000元"),
            vue.createElementVNode("view", { class: "leasingConTop_t2" }, " 发布人：这是一个名字 "),
            vue.createElementVNode("view", { class: "indexServiceLiTT1Label" }, [
              vue.createElementVNode("text", { style: { "background": "#71e58d" } }, "电工"),
              vue.createElementVNode("text", { style: { "background": "#ffdb00" } }, "车主")
            ]),
          ...
          vue.createElementVNode("view", { class: "leasingConBot" }, [
            vue.createElementVNode("view", { class: "leasingConBotTit" }, "详情"),
            vue.createElementVNode("view", { class: "leasingConBotTex" }, [
              vue.createElementVNode("text", null, " 内容介绍内容介绍内容介绍内容介绍内容介绍 内容介绍内容介绍内容介绍 内容介绍 内容介绍内容介绍内容介绍内容介绍 电话号1264985148地址地址地址地址地址地 地址地址址 "),
              vue.createElementVNode("image", {
                src: "/static/images/goods_1.png",
                mode: "widthFix"
              })
          ...
          vue.createElementVNode("view", { class: "leasingMeun" }, [
            vue.createElementVNode("view", { class: "leasingMeunLeft" }, [
              vue.createElementVNode("image", {
                src: "/static/images/goods_9.png",
                mode: "widthFix"
              }),
              vue.createElementVNode("text", null, "在线对话")
            ]),
            vue.createElementVNode("view", {
              class: "leasingMeunRight",
              click: "makePhoneCall"
            }, " 拨打电话 ")
          ])
        ])
  ...
  const PagesDeviceDeviceCon = /* @__PURE__ */ _export_sfc(_sfc_main$N, [["render", _sfc_render$M], ["__file", "D:/cindy/yikegongcheng/yike/pages/device/device-con.vue"]]);
  const _sfc_main$M = {
    data() {
      return {
        items: [
  ...
  const PagesDeviceDeviceShop = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["render", _sfc_render$L], ["__file", "D:/cindy/yikegongcheng/yike/pages/device/device-shop.vue"]]);
  const fontData = [
    {
  ...
  const __easycom_0$7 = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["render", _sfc_render$K], ["__scopeId", "data-v-946bce22"], ["__file", "D:/cindy/yikegongcheng/yike/node_modules/@dcloudio/uni-ui/lib/uni-icons/uni-icons.vue"]]);
  const _sfc_main$K = {
    props: {
      activePage: {
        type: Number,
  ...
  const __easycom_0$6 = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["render", _sfc_render$J], ["__scopeId", "data-v-a6d140ed"], ["__file", "D:/cindy/yikegongcheng/yike/components/custom-tabs-bar/custom-tabs-bar.vue"]]);
  const _sfc_main$J = {
    components: {
      CustomTabsBar: __easycom_0$6
    },
    data() {
      return {
        number: 1543637
  ...
  function _sfc_render$I(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_custom_tabs_bar = resolveEasycom(vue.resolveDynamicComponent("custom-tabs-bar"), __easycom_0$6);
  ...
  const PagesUserUser = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["render", _sfc_render$I], ["__file", "D:/cindy/yikegongcheng/yike/pages/user/user.vue"]]);
  const _sfc_main$I = {
    data() {
      return {
        nickname: "",
  ...
  const PagesUserUserPersonal = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["render", _sfc_render$H], ["__file", "D:/cindy/yikegongcheng/yike/pages/user/user-personal.vue"]]);
  const _sfc_main$H = {
    data() {
      return {
  ...
  const PagesUserUserToup = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["render", _sfc_render$G], ["__file", "D:/cindy/yikegongcheng/yike/pages/user/user-toup.vue"]]);
  const _sfc_main$G = {
    data() {
      return {
        rating: 4,
  ...
  const PagesUserUserFeedback = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["render", _sfc_render$F], ["__file", "D:/cindy/yikegongcheng/yike/pages/user/user-feedback.vue"]]);
  const _sfc_main$F = {
    data() {
      return {
        showElement: false
  ...
  const PagesUserUserMyService = /* @__PURE__ */ _export_sfc(_sfc_main$F, [["render", _sfc_render$E], ["__file", "D:/cindy/yikegongcheng/yike/pages/user/user-my-service.vue"]]);
  const pages = [
    {
    ...
    {
      path: "pages/device/device-lease",
      style: {
    ...
    {
      path: "pages/user-order/order-dsh",
      style: {
        navigationBarTitleText: "我的订单"
      }
    },
    {
      path: "pages/user-order/order-ywc",
      style: {
        navigationBarTitleText: "我的订单"
      }
    },
    {
      path: "pages/user-order/order-dfh",
      style: {
        navigationBarTitleText: "我的订单"
      }
    },
    ...
    {
      path: "pages/user/user-honorary-title",
      style: {
        navigationBarTitleText: "荣誉称号"
      }
    },
    {
      path: "pages/user/user-service",
      style: {
        navigationBarTitleText: "APP客服"
      }
    },
    {
    ...
    {
      path: "pages/job/job-pus",
      style: {
        navigationBarTitleText: "发布"
      }
    },
    {
      path: "pages/job/job-list",
      style: {
        navigationBarTitleText: "招牌求职",
        navigationBarBackgroundColor: "#caffd4",
        navigationBarTextStyle: "black"
      }
    },
    {
      path: "pages/local/publish",
      style: {
    ...
    {
      path: "pages/machinery/leasing",
      style: {
        navigationBarTitleText: "机械租赁",
        navigationBarBackgroundColor: "#caffd4",
        navigationBarTextStyle: "black"
      }
    },
    {
      path: "pages/machinery/leasing-con",
      style: {
        navigationBarTitleText: "详情",
        navigationBarBackgroundColor: "#fff",
        navigationBarTextStyle: "black"
    ...
    {
      path: "pages/goods/goods-content",
      style: {
        navigationBarTitleText: "详情",
        navigationBarBackgroundColor: "#fff",
        navigationBarTextStyle: "black"
    ...
    {
      path: "pages/forum/forum-content",
      style: {
        navigationBarTitleText: "详情",
        navigationBarBackgroundColor: "#fff",
        navigationBarTextStyle: "black"
...
详细信息：${s4}`), r3(i3);
  ...
  const uploadImage = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["render", _sfc_render$D], ["__scopeId", "data-v-6f3c6077"], ["__file", "D:/cindy/yikegongcheng/yike/node_modules/@dcloudio/uni-ui/lib/uni-file-picker/upload-image.vue"]]);
  const _sfc_main$D = {
    name: "uploadFile",
    emits: ["uploadFiles", "choose", "delFile"],
    props: {
  ...
  const uploadFile = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["render", _sfc_render$C], ["__scopeId", "data-v-86fc2bba"], ["__file", "D:/cindy/yikegongcheng/yike/node_modules/@dcloudio/uni-ui/lib/uni-file-picker/upload-file.vue"]]);
  const _sfc_main$C = {
    name: "uniFilePicker",
    components: {
      uploadImage,
  ...
  const __easycom_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["render", _sfc_render$B], ["__scopeId", "data-v-418f48eb"], ["__file", "D:/cindy/yikegongcheng/yike/node_modules/@dcloudio/uni-ui/lib/uni-file-picker/uni-file-picker.vue"]]);
  const _sfc_main$B = {
    data() {
      return {
        rating: 4,
  ...
  const PagesUserOrderIssueEvaluate = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["render", _sfc_render$A], ["__file", "D:/cindy/yikegongcheng/yike/pages/user-order/issue-evaluate.vue"]]);
  const _sfc_main$A = {
    name: "UniSteps",
    props: {
      direction: {
  ...
  const __easycom_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["render", _sfc_render$z], ["__scopeId", "data-v-afee76c1"], ["__file", "D:/cindy/yikegongcheng/yike/node_modules/@dcloudio/uni-ui/lib/uni-steps/uni-steps.vue"]]);
  const _sfc_main$z = {
    components: {},
    data() {
      return {
  ...
  const PagesUserOrderOrderLogistics = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["render", _sfc_render$y], ["__file", "D:/cindy/yikegongcheng/yike/pages/user-order/order-logistics.vue"]]);
  const _sfc_main$y = {};
  ...
  const PagesUserOrderOrderDsh = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["render", _sfc_render$x], ["__file", "D:/cindy/yikegongcheng/yike/pages/user-order/order-dsh.vue"]]);
  const _sfc_main$x = {};
  ...
  const PagesUserOrderOrderYwc = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["render", _sfc_render$w], ["__file", "D:/cindy/yikegongcheng/yike/pages/user-order/order-ywc.vue"]]);
  const _sfc_main$w = {};
  ...
  const PagesUserOrderOrderDfh = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["render", _sfc_render$v], ["__file", "D:/cindy/yikegongcheng/yike/pages/user-order/order-dfh.vue"]]);
  const _sfc_main$v = {
    data() {
      return {
        showElement: false
  ...
  const PagesUserUserMyInvitation = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["render", _sfc_render$u], ["__file", "D:/cindy/yikegongcheng/yike/pages/user/user-my-invitation.vue"]]);
  const _sfc_main$u = {
    data() {
      return {
        items: [
  ...
  const PagesUserUserHonoraryTitle = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["render", _sfc_render$t], ["__file", "D:/cindy/yikegongcheng/yike/pages/user/user-honorary-title.vue"]]);
  const _sfc_main$t = {};
  ...
  const PagesUserUserService = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["render", _sfc_render$s], ["__file", "D:/cindy/yikegongcheng/yike/pages/user/user-service.vue"]]);
  const _sfc_main$s = {};
  ...
  const PagesUserUserInvitationMessage = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$r], ["__file", "D:/cindy/yikegongcheng/yike/pages/user/user-invitation-message.vue"]]);
  const _sfc_main$r = {
    data() {
      return {
        inputContent: "",
  ...
  const PagesJobJobPus = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["render", _sfc_render$q], ["__file", "D:/cindy/yikegongcheng/yike/pages/job/job-pus.vue"]]);
  const _sfc_main$q = {
    data() {
      return {
        items: [
  ...
  const PagesJobJobList = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$p], ["__file", "D:/cindy/yikegongcheng/yike/pages/job/job-list.vue"]]);
  const _sfc_main$p = {
    data() {
      return {
        inputContent: "",
      ...
      [
        ...
        vue.createElementVNode("view", { class: "uploadBody" }, [
          vue.createElementVNode("view", { class: "uploadBodyTit" }, [
            ...
            vue.createElementVNode("view", { class: "uploadBodyTit_t2" }, "使用10个亦可币可发布1条服务")
          ]),
          vue.createElementVNode("view", { class: "uploadBodyForm" }, [
            vue.createElementVNode("input", {
              "placeholder-style": "font-size:30rpx",
          ...
          vue.createElementVNode("view", { class: "uploadBodyCityClass" }, [
            vue.createElementVNode("view", { class: "uploadBodyCityClassBtn" }, "选择城市"),
            vue.createElementVNode("view", { class: "uploadBodyCityClassBtn" }, "选择分类")
          ]),
  ...
  const PagesLocalPublish = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$o], ["__file", "D:/cindy/yikegongcheng/yike/pages/local/publish.vue"]]);
  ...
  const __easycom_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["render", _sfc_render$n], ["__scopeId", "data-v-2c1dd21f"], ["__file", "D:/cindy/yikegongcheng/yike/node_modules/@dcloudio/uni-ui/lib/uni-load-more/uni-load-more.vue"]]);
  const dataPicker = {
    props: {
      localdata: {
        type: [Array, Object],
  ...
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["render", _sfc_render$l], ["__scopeId", "data-v-e10759db"], ["__file", "D:/cindy/yikegongcheng/yike/node_modules/@dcloudio/uni-ui/lib/uni-data-picker/uni-data-picker.vue"]]);
  const _sfc_main$l = {
    name: "UniSwiperDot",
    emits: ["clickItem"],
    props: {
  ...
  function _sfc_render$j(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "" }, [
      ...
      vue.createElementVNode("view", { class: "indexFourClass" }, [
        vue.createElementVNode("navigator", { url: "../goods/goods-index" }, [
        ...
        vue.createElementVNode("navigator", { url: "../../pages/machinery/leasing" }, [
          vue.createElementVNode("view", { class: "indexFourClassLi indexFourClassLiG" }, [
            vue.createElementVNode("text", null, "机械租赁"),
            vue.createElementVNode("image", { src: "/static/images/index_3.png" })
          ])
        ])
      ]),
      ...
      vue.createCommentVNode(" 板块图片 "),
      vue.createElementVNode("view", { class: "indexFourClass" }, [
        vue.createElementVNode("navigator", { url: "../../pages/device/device-shop" }, [
          vue.createElementVNode("view", { class: "indexFourClassLi indexFourClassLiB" }, [
            vue.createElementVNode("text", null, "设备商城"),
            vue.createElementVNode("image", { src: "/static/images/index_3.png" })
          ])
        ]),
        vue.createElementVNode("navigator", { url: "../../pages/local/service" }, [
      ...
      vue.createVNode(_component_custom_tabs_bar, { activePage: "0" }),
  ...
  const PagesLocalServiceCon = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$i], ["__file", "D:/cindy/yikegongcheng/yike/pages/local/service-con.vue"]]);
  const _sfc_main$i = {
    data() {
      return {
        items: [
  ...
  const PagesLocalService = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$h], ["__file", "D:/cindy/yikegongcheng/yike/pages/local/service.vue"]]);
  const _sfc_main$h = {
    data() {
      return {
        items: [
  ...
  const PagesMachineryLeasing = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$g], ["__file", "D:/cindy/yikegongcheng/yike/pages/machinery/leasing.vue"]]);
  const _sfc_main$g = {
    methods: {
      makePhoneCall() {
        uni.makePhoneCall({
  ...
  const PagesAddressIndex = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$e], ["__file", "D:/cindy/yikegongcheng/yike/pages/address/index.vue"]]);
  const _sfc_main$e = {
    data() {
      return {
        selectedRegion: [],
  ...
  const PagesAddressAdd = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$d], ["__file", "D:/cindy/yikegongcheng/yike/pages/address/add.vue"]]);
  const _sfc_main$d = {};
  ...
  const PagesGoodsComment = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["__file", "D:/cindy/yikegongcheng/yike/pages/goods/comment.vue"]]);
  const _sfc_main$c = {
    data() {
      return {
        items: [
    ...
    return vue.openBlock(), vue.createElementBlock(
      ...
      [
        ...
        vue.createElementVNode("view", { class: "" }, [
          ...
          vue.createVNode(_component_custom_tabs_bar, { activePage: "3" }),
          vue.createCommentVNode(" current属性指示哪个tab是活跃的 ")
        ])
      ],
      2112
  ...
  const PagesGoodsGoodsIndex = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__file", "D:/cindy/yikegongcheng/yike/pages/goods/goods-index.vue"]]);
  const _sfc_main$b = {
    data() {
      return {};
    },
  ...
  const PagesPayPay = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__file", "D:/cindy/yikegongcheng/yike/pages/pay/pay.vue"]]);
  class MPAnimation {
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__file", "D:/cindy/yikegongcheng/yike/node_modules/@dcloudio/uni-ui/lib/uni-transition/uni-transition.vue"]]);
  const _sfc_main$9 = {
    name: "uniPopup",
    components: {},
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-7db519c7"], ["__file", "D:/cindy/yikegongcheng/yike/node_modules/@dcloudio/uni-ui/lib/uni-popup/uni-popup.vue"]]);
  const _sfc_main$8 = {
    data() {
      return {
        images: [
  ...
  const PagesGoodsGoodsContent = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__file", "D:/cindy/yikegongcheng/yike/pages/goods/goods-content.vue"]]);
  const _sfc_main$7 = {
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-123e8af9"], ["__file", "D:/cindy/yikegongcheng/yike/node_modules/@dcloudio/uni-ui/lib/uni-data-select/uni-data-select.vue"]]);
  const _sfc_main$6 = {
    components: {
      CustomTabsBar: __easycom_0$6
    },
    data() {
      return {
        ...
        number: 1,
        cnumber: 12e3,
        classitems: ["全部分类", "分类1", "分类2", "分类3", "分类4", "分类5", "分类6", "分类7", "分类8", "分类9"],
        isSticky: false,
        topThreshold: 0,
        // 根据实际布局调整
        isLiked: false,
    ...
    computed: {
      ...
      commentNumber() {
        if (this.cnumber >= 1e5) {
          return (this.cnumber / 1e4).toFixed(0) + "w";
        } else if (this.cnumber >= 1e4) {
          return (this.cnumber / 1e4).toFixed(1) + "w";
        } else {
          return this.cnumber;
        }
      }
    ...
    onReady() {
      const query = uni.createSelectorQuery();
      query.select(".forumClass").boundingClientRect((rect) => {
        this.topThreshold = rect.top;
      }).exec();
    },
    onPageScroll(e2) {
  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock(
      ...
      {
        class: "handleScroll",
        onScroll: _cache[9] || (_cache[9] = (...args) => _ctx.handleScroll && _ctx.handleScroll(...args))
      },
      [
        vue.createElementVNode("view", { class: "indexTopPosition" }, [
          vue.createElementVNode("image", {
        ...
        vue.createElementVNode("view", { class: "fourmRecommend" }, [
          vue.createElementVNode("view", { class: "fourmRecommendTop" }, [
            ...
            vue.createElementVNode("view", { class: "fourmRecommendTopLine" }, [
              ...
              vue.createElementVNode("view", { class: "fourmRecommendTopT1" }, "吉林长春 · 推荐圈子")
            ])
          ]),
          vue.createElementVNode("view", { class: "fourmRecommendBot" }, [
            vue.createElementVNode("navigator", {
              "hover-class": "none",
              url: "/pages/forum/forum-list",
              class: "fourmRecommendBotLi"
            }, [
              vue.createElementVNode("image", {
                src: "/static/images/forum_2.png",
          ...
          vue.createElementVNode(
            "view",
            {
              class: vue.normalizeClass({ "forumClass": true, "sticky": $data.isSticky })
            },
            [
              vue.createElementVNode("scroll-view", {
                class: "scroll-view",
                ...
                vue.createCommentVNode(" 这里是滚动的分类条目 "),
                (vue.openBlock(true), vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList($data.classitems, (item, index) => {
                    return vue.openBlock(), vue.createElementBlock("view", {
                      class: "forumClassLi",
                      key: index
                    }, [
          ...
          vue.createElementVNode("view", { class: "forumSelect" }, [
            vue.createElementVNode("view", { class: "forumSelectTit" }, "默认筛选"),
            vue.createVNode(_component_uni_data_select, {
              class: "forumSelectC",
              modelValue: $data.valueSe,
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.valueSe = $event),
              localdata: $data.range,
              onChange: $options.changeSe
            }, null, 8, ["modelValue", "localdata", "onChange"])
          ]),
          vue.createElementVNode("view", { class: "forumSelectUl" }, [
            vue.createElementVNode("view", { class: "forumSelectUlLi" }, [
              vue.createElementVNode("navigator", {
                "hover-class": "none",
                class: "forumSelectUlLiTop"
              }, [
                vue.createElementVNode("image", {
                  src: "/static/images/forum_2.png",
                ...
                vue.createElementVNode("view", { class: "forumSelectUlLiTopLeft" }, [
                  vue.createElementVNode("view", { class: "forumSelectUlLiTopLeftName" }, [
                    vue.createElementVNode("text", { class: "forumSelectUlLiTopLeftNameTxt" }, "自由的宝飞飞飞飞飞飞飞飞飞飞飞飞飞飞飞飞飞飞飞飞飞"),
                ...
                vue.createElementVNode("image", {
                  class: "forumSelectUlLiTopLeftUp",
                  src: "/static/images/forum_4.png",
                  mode: "widthFix"
                })
              ]),
              vue.createElementVNode("view", { class: "forumSelectUlLiCon" }, [
                vue.createElementVNode("navigator", {
                  url: "/pages/forum/forum-con",
                  "hover-class": "none",
                  class: "forumSelectUlLiConTxt"
                }, [
                  vue.createTextVNode(" 内容文字内容文字内容文字内容文字~~~ "),
                  vue.createElementVNode("br"),
                  vue.createTextVNode(" 哈哈哈哈~~~~~ ")
                ]),
                ...
                vue.createElementVNode("view", { class: "forumSelectUlLiConBot" }, [
                  vue.createElementVNode("navigator", {
                    url: "/pages/forum/forum-con",
                    "hover-class": "none",
                    class: "forumSelectUlLiConBotComment"
                  }, [
                    vue.createElementVNode("image", {
                      src: "/static/images/forum_7.png",
                      mode: "widthFix"
                    }),
                    vue.createElementVNode(
                      "text",
                      null,
                      "评论(" + vue.toDisplayString($options.commentNumber) + ")",
                      1
                      /* TEXT */
                    )
                  ]),
            ...
            vue.createElementVNode("view", { class: "forumSelectUlLi" }, [
              ...
              vue.createElementVNode("view", { class: "forumSelectUlLiCon" }, [
                ...
                vue.createElementVNode("view", { class: "forumSelectUlLiConImg" }, [
                  vue.createElementVNode("view", {
                    onClick: _cache[4] || (_cache[4] = (...args) => $options.previewImage && $options.previewImage(...args)),
                    style: { "background": "url(http://www.moehosp.com/Public/home/images/about/about_team.png) no-repeat center center" },
                    class: "forumSelectUlLiConImgBack"
                  }),
                  vue.createElementVNode("view", {
                ...
                vue.createElementVNode("view", { class: "forumSelectUlLiConBot" }, [
                  ...
                  vue.createElementVNode("view", { class: "forumSelectUlLiConBotGood" }, [
                    vue.createElementVNode(
                      "text",
                      null,
                      "点赞(" + vue.toDisplayString($options.formattedNumber) + ")",
                      1
                      /* TEXT */
                    ),
                    vue.createElementVNode("image", {
            ...
            vue.createElementVNode("view", { class: "forumSelectUlLi" }, [
              ...
              vue.createElementVNode("view", { class: "forumSelectUlLiCon" }, [
                ...
                vue.createElementVNode("view", { class: "forumSelectUlLiConImg" }, [
                  vue.createElementVNode("view", {
                    onClick: _cache[5] || (_cache[5] = (...args) => $options.previewImage && $options.previewImage(...args)),
                    style: { "background": "url(http://www.moehosp.com/Public/home/images/about/about_team.png) no-repeat center center" },
                    class: "forumSelectUlLiConImgBack"
                  }),
                  vue.createElementVNode("view", {
            ...
            vue.createElementVNode("view", { class: "forumSelectUlLi" }, [
              ...
              vue.createElementVNode("view", { class: "forumSelectUlLiCon" }, [
                ...
                vue.createElementVNode("view", { class: "forumSelectUlLiConImg" }, [
                  vue.createElementVNode("view", {
                    onClick: _cache[6] || (_cache[6] = (...args) => $options.previewImage && $options.previewImage(...args)),
                    style: { "background": "url(http://www.moehosp.com/Public/home/images/about/about_team.png) no-repeat center center" },
                    class: "forumSelectUlLiConImgBack"
                  }),
                  vue.createElementVNode("view", {
            ...
            vue.createElementVNode("view", { class: "forumSelectUlLi" }, [
              ...
              vue.createElementVNode("view", { class: "forumSelectUlLiCon" }, [
                ...
                vue.createElementVNode("view", { class: "forumSelectUlLiConImg" }, [
                  vue.createElementVNode("view", {
                    onClick: _cache[7] || (_cache[7] = (...args) => $options.previewImage && $options.previewImage(...args)),
                    style: { "background": "url(http://www.moehosp.com/Public/home/images/about/about_team.png) no-repeat center center" },
                    class: "forumSelectUlLiConImgBack"
                  }),
                  vue.createElementVNode("view", {
          ...
          vue.createElementVNode("view", { class: "page" }, [
            vue.createElementVNode(
              "view",
              {
                class: vue.normalizeClass(["forumSelectbtn", { expanded: $data.isExpanded }]),
                onClick: _cache[8] || (_cache[8] = (...args) => $options.toggleButton && $options.toggleButton(...args))
              },
              [
                vue.createElementVNode("navigator", {
                  url: "../../pages/forum/forum-upload",
                  "hover-class": "none"
                }, [
                  vue.createElementVNode("image", {
                    class: "forumSelectbtn_1",
                    src: "/static/images/forum_10.png",
                    mode: "widthFix"
                  })
                ]),
                vue.createElementVNode("navigator", {
                  ...
                  vue.createElementVNode("image", {
                    class: "forumSelectbtn_1",
                    src: "/static/images/forum_11.png",
                    mode: "widthFix"
                  })
                ]),
                vue.createElementVNode("navigator", {
                  ...
                  vue.createElementVNode("image", {
                    class: "forumSelectbtn_1",
                    src: "/static/images/forum_12.png",
                    mode: "widthFix"
                  })
                ])
              ],
        ...
        vue.createVNode(_component_custom_tabs_bar, { activePage: "1" }),
        vue.createCommentVNode(" current属性指示哪个tab是活跃的 ")
      ],
      32
      /* NEED_HYDRATION */
  ...
  const PagesForumForumIndex = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "D:/cindy/yikegongcheng/yike/pages/forum/forum-index.vue"]]);
  const _sfc_main$5 = {
    data() {
      return {
        valueSe: 1,
    ...
    methods: {
      changeSe(e2) {
        formatAppLog("log", "at pages/forum/forum-list.vue:268", "e:", e2);
      },
      // 点击查看放大图片
      previewImage() {
        uni.previewImage({
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock(
      ...
      null,
      [
        vue.createCommentVNode(" 从热门进入的列表页面 "),
        vue.createElementVNode("view", { class: "handleScroll" }, [
          vue.createElementVNode("view", { class: "indexTopPositionConSearchInput" }, [
            vue.createElementVNode("image", {
              src: "/static/images/index_6.png",
              mode: "widthFix"
          ...
          vue.createElementVNode("view", { class: "forumSelect" }, [
            ...
            vue.createVNode(_component_uni_data_select, {
              class: "forumSelectC",
              modelValue: $data.valueSe,
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.valueSe = $event),
              localdata: $data.range,
              onChange: $options.changeSe
            }, null, 8, ["modelValue", "localdata", "onChange"])
          ]),
          vue.createElementVNode("view", { class: "forumSelectUl" }, [
            ...
            vue.createElementVNode("view", { class: "forumSelectUlLi" }, [
              ...
              vue.createElementVNode("view", { class: "forumSelectUlLiCon" }, [
                ...
                vue.createElementVNode("view", { class: "forumSelectUlLiConImg" }, [
                  vue.createElementVNode("view", {
                    onClick: _cache[3] || (_cache[3] = (...args) => $options.previewImage && $options.previewImage(...args)),
                    style: { "background": "url(http://www.moehosp.com/Public/home/images/about/about_team.png) no-repeat center center" },
                    class: "forumSelectUlLiConImgBack"
                  }),
                  vue.createElementVNode("view", {
  ...
  const PagesForumForumList = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "D:/cindy/yikegongcheng/yike/pages/forum/forum-list.vue"]]);
  const _sfc_main$4 = {
    data() {
      return {
        isLiked: false,
        ...
        vue.createElementVNode("view", { class: "forumPostsBotUl" }, [
          vue.createElementVNode("view", { class: "forumPostsBotUlLi" }, [
            ...
            vue.createElementVNode("view", { class: "forumPostsBotUlLiComment" }, [
              ...
              vue.createElementVNode("view", {
                class: "forumPostsBotUlLiCommentLiMore",
                onClick: _cache[2] || (_cache[2] = (...args) => $options.open && $options.open(...args))
              }, "查看全部回复 >>")
            ])
          ]),
          vue.createCommentVNode(" 查看全部回复 弹窗 "),
          vue.createVNode(
            _component_uni_popup,
            {
              ref: "popup",
            ...
            {
              default: vue.withCtx(() => [
                vue.createElementVNode("view", { class: "forumPostsPopup" }, [
                  vue.createElementVNode("view", { class: "forumPostsPopupTit" }, [
                    vue.createVNode(_component_uni_icons, {
                      class: "forumPostsPopupTitClose",
                      type: "close",
                      size: "30",
                      color: "#222",
                      onClick: $options.close
                    }, null, 8, ["onClick"]),
                    vue.createElementVNode("text", { class: "forumPostsPopupTit_t1" }, "评论的全部回复")
                  ]),
                  vue.createElementVNode("view", { class: "forumPostsBotUlLiComment" }, [
                    vue.createElementVNode("view", { class: "forumPostsBotUlLiTop" }, [
                      vue.createElementVNode("image", {
                  ...
                  vue.createElementVNode("view", { class: "forumPostsPopupBot" }, [
                    vue.createElementVNode("view", { class: "forumPostsPopupBotNum" }, "6条回复"),
                    vue.createElementVNode("view", { class: "forumPostsPopupBotUl" }, [
                      vue.createElementVNode("view", { class: "forumPostsPopupBotUlLi" }, [
                        vue.createElementVNode("view", { class: "forumPostsBotUlLiTop" }, [
                          vue.createElementVNode("image", {
                            src: "/static/images/forum_2.png",
                            class: "forumPostsBotUlLiTopImg"
                          ...
                          vue.createElementVNode("view", { class: "forumPostsBotUlLiTopLeft" }, [
                            vue.createElementVNode("text", { class: "forumPostsBotUlLiTopLeftName" }, "我没说话"),
                            vue.createElementVNode("view", { class: "forumPostsBotUlLiTopLeftTab" }, [
                              vue.createElementVNode("view", {
                                style: { "background": "#ffdb00" },
                                class: "forumPostsBotUlLiTopLeftTabLi"
                        ...
                        vue.createElementVNode("view", { class: "forumPostsBotUlLiTxt" }, [
                          vue.createElementVNode("view", { class: "forumPostsBotUlLiTxt_t1" }, " 真麻烦 "),
                          vue.createElementVNode("view", { class: "forumPostsBotUlLiTxt_t2" }, " 2024-04-15 16:09:32 "),
                          vue.createElementVNode("view", { class: "forumPostsPopupBotUlLi" }, [
                            vue.createElementVNode("image", {
                              class: "forumPostsPopupBotUlLi_img1",
                              src: "/static/images/forum_8.png",
                              mode: "widthFix"
                            }),
                            vue.createElementVNode("text", null, "赞"),
                            vue.createElementVNode("image", {
                              class: "forumPostsPopupBotUlLi_img2",
                              src: "/static/images/forum_13.png",
                              mode: "widthFix"
                            })
                          ])
                        ])
                    ...
                    vue.createElementVNode("view", { class: "forumPostsPopupReply" }, [
                      vue.createElementVNode("view", { class: "forumPostsPopupReplyTit" }, "回复 我没说话"),
                      vue.createElementVNode("view", { class: "forumPostsPopupReplyForm" }, [
                        vue.createElementVNode("textarea", {
                          class: "forumPostsPopupReplyFormInt",
                          value: "",
                          maxlength: "50",
                          placeholder: "发布评论，说点好听的"
                        }),
                        vue.createElementVNode("view", { class: "forumPostsPopupReplyFormBtn" }, "发表")
                      ])
                    ])
                  ])
                ])
  ...
  const PagesForumForumContent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "D:/cindy/yikegongcheng/yike/pages/forum/forum-content.vue"]]);
  const _sfc_main$3 = {
    data() {
      return {
        inputContent: "",
  ...
  const PagesForumForumUpload = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "D:/cindy/yikegongcheng/yike/pages/forum/forum-upload.vue"]]);
  const _sfc_main$2 = {
    data() {
      return {
        imageStyles: {
  ...
  const PagesMerchantSignin = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-79519696"], ["__file", "D:/cindy/yikegongcheng/yike/pages/Merchant/signin.vue"]]);
  const _sfc_main$1 = {};
  function _sfc_render(_ctx, _cache) {
    const _component_custom_tabs_bar = resolveEasycom(vue.resolveDynamicComponent("custom-tabs-bar"), __easycom_0$6);
    return vue.openBlock(), vue.createElementBlock("view", { class: "" }, [
      vue.createVNode(_component_custom_tabs_bar, { activePage: "2" })
    ]);
  }
  ...
  __definePage("pages/user-order/order-dfh", PagesUserOrderOrderDfh);
  ...
  __definePage("pages/local/service-con", PagesLocalServiceCon);
  __definePage("pages/local/service", PagesLocalService);
  __definePage("pages/machinery/leasing", PagesMachineryLeasing);
  __definePage("pages/machinery/leasing-con", PagesMachineryLeasingCon);
  ...
  __definePage("pages/forum/forum-content", PagesForumForumContent);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/cindy/yikegongcheng/yike/App.vue"]]);
  function createApp() {
